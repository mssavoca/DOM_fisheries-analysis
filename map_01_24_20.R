...
p=p+  geom_scatterpie(aes(x=x,y=y,r = 4,),data=bycatch,cols=colnames(bycatch)[2:9],color=NA)+coord_fixed() +
  ...
  annotate("text",x=-117.5,y=14,label="Alaska (n=19)",size=2,color="#555555")+annotate("text",x=-68,y=31,label="Northeast (n=43)",size=2,color="#555555")+
  annotate("text",x=-105,y=14,label="Pacific Islands (n=3)",size=2,color="#555555")+annotate("text",x=-74,y=18,label="Southeast (n=12)",size=2,color="#555555")+
  annotate("text",x=-130,y=40,label="West Coast (n=18)",size=2,color="#555555")+
